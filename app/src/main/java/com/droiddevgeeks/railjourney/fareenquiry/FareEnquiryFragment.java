...
public class FareEnquiryFragment extends Fragment implements View.OnClickListener, IDownloadListener, DatePickerDialog.OnDateSetListener
{
    ...
    private Spinner passengerAgeRange, journeyQuota;
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState)
    {
        ...
        passengerAgeRange = (Spinner) view.findViewById(R.id.spinnerPassengerAge);
        passengerAgeRange.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()
        {
            @Override
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l)
            {

                String[] age_values = getContext().getResources().getStringArray(R.array.traveller_age_value);
                age = age_values[i];
            }
    ...
    private void fetchFareFromServer()
    {
        ...
        {
            FareResultFragment fareResultFragment = new FareResultFragment();
            fareResultFragment.setInputDataForApi(trainCode, sourceCode, destinationCode, age, quota, "" + doj.getText());
            getFragmentManager().beginTransaction().replace(R.id.container, fareResultFragment).addToBackStack(null).commit();
        }
        else
        {
